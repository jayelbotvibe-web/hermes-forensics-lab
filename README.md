...
```
┌─ Host (Hermes Forensics Profile) ────────────────────────────────┐
│                                                                    │
│  Docker (evidence bind-mounted directly):                          │
│  ┌──────────┐ ┌──────────┐ ┌──────────┐                           │
│  │volatility│ │  plaso   │ │mft-tools │ ← version-pinned          │
│  │  :2.7.0  │ │ :20240512│ │ :1.2.0.0 │ ← validates on build     │
│  └──────────┘ └──────────┘ └──────────┘                           │
│                                                                    │
│  Host FUSE:                                                        │
│  ┌──────────┐                                                      │
│  │MemProcFS │ ← mounts memory as virtual filesystem               │
│  │ :5.17.8  │   agent browses like a directory                    │
│  └──────────┘                                                      │
│                                                                    │
│  Evidence: ~/forensics/cases/ (LUKS encrypted, 30GB)               │
│                                                                    │
│         │ SSH                                                     │
│         ▼                                                         │
│  ┌──────────────────────────────────────────┐                     │
│  │  SIFT Workstation VM (VMware, 12GB, 4CPU)│                     │
│  │  Evidence mounted via SSHFS (read-only)  │                     │
│  │  ┌──────────┐ ┌──────────┐ ┌──────────┐  │                     │
│  │  │sleuthkit │ │ foremost │ │ dc3dd    │  │                     │
│  │  │regripper │ │ hashdeep │ │ tshark   │  │                     │
│  │  │photorec  │ │ ddrescue │ │ ewf-tools│  │                     │
│  │  └──────────┘ └──────────┘ └──────────┘  │                     │
│  └──────────────────────────────────────────┘                     │
└────────────────────────────────────────────────────────────────────┘
```
