...
[**→ View HTML Report**](reports/samples/belkactf7-data-report.html) &nbsp;·&nbsp; [**Download PDF (63KB)**](reports/samples/belkactf7-data-report.pdf)

*Generated by `forensics-report.sh` from `findings.json` + `timeline.json` + `evidence.json`*
