---
name: mft-analysis
description: "MFT parsing with analyzeMFT — file records, timestamps, resident data, and ADS detection"
version: 1.0.0
category: forensics
---
...
3. When MFTECmd becomes available: dual-tool cross-validation
